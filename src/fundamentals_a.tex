...
\begin{equation}
\rho_g(x_1,t)=\int \mathrm{d}x_2\dots\mathrm{d}x_N\Psi_g^*(x_1,x_2,\dots,x_N;t)\Psi_g(x_1,x_2,\dots,x_N;t)
...
\begin{equation}
f_n^{eh}(x_1,t)=\int \mathrm{d}x_2\dots\mathrm{d}x_N\Psi_g^*(x_1,x_2,\dots,x_N;t)\Psi_n(x_1,x_2,\dots,x_N;t)
...
\begin{equation}
    f_n^{eh}(x_1,t)=e^{-i(E_n-E_g)t}\int\mathrm{d}x_2\dots\mathrm{d}x_N\Psi_g^*(x_1,x_2,\dots,x_N;t)\Psi_n(x_1,x_2,\dots,x_N;t)
\label{mod_transition_one-body}
\end{equation}

Here, $\int\mathrm{d}x_2\dots\mathrm{d}x_N\Psi_g^*(x_1,x_2,\dots,x_N;t)\Psi_n(x_1,x_2,\dots,x_N;t)$ denotes the transition amplitude.
...
Up to now, we do not know any solution for these complicated calculations. We introduce a compact quantity $Q$. Rather than calculating different $Q_i$ admissions for every $\Omega_i[Q_i]$. We had better insist to find one $Q$ where $\Omega_i[Q]$ is possible. Then, find $\Omega_i[Q]$ for observables of interest, and find a way to calculate that $Q$.
