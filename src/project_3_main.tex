...
Hydrogen functionalization substantially modifies the structural and electronic properties.
It yields stable hydrogen-functionalized configurations and drives $\alpha$-beryllene into a wide-gap semiconducting state,
while preserving metallic behaviour in hydrogen-functionalized $\beta$-based structures.
...
The results identify stable hydrogen-functionalized structures and a cubic trilayer geometry with non-trivial $Z_{2}$ topology.
...
Hydrogen functionalization can modify the structural and electronic properties of a two-dimensional material by changing the local bonding environment.
...
likely through band-structure modification and the formation of new hybridized states involving hydrogen.
...
The 2H-$\alpha$-beryllene phase transforms from a metallic system into a wide-gap semiconductor,
...
The calculated optical properties demonstrate that dimensional reduction and hydrogen functionalization strongly modify the dielectric response of beryllium.
...
Hydrogen functionalization further redistributes optical spectral weight and shifts the characteristic excitation energies through changes in electronic hybridization and screening.
...
these findings identify two-dimensional beryllium as an elemental platform in which structural design and hydrogen functionalization can tune electronic,
