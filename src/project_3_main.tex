...
\begin{tabular}{@{}c@{}c@{}c@{}}
    ...
    \\\adjustbox{valign=c}{\includegraphics[width=0.25\linewidth]{figures_proj3/fig3.7/fig3.7a2.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.25\linewidth]{figures_proj3/fig3.7/fig3.7b2.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.25linewidth]{figures_proj3/fig3.7/fig3.7c2.pdf}}%
\end{tabular}
\caption{testAb initio molecular dynamics simulations for the hydrogen-functionalized beryllene structures.
...
\centering
\begin{tabular}{@{}c@{}c@{}c@{}}
    \adjustbox{valign=c}{\includegraphics[width=0.75\linewidth]{figures_proj3/fig3.7/fig3.7a1.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.25\linewidth]{figures_proj3/fig3.7/fig3.7a2.pdf}}%
    \\\adjustbox{valign=c}{\includegraphics[width=0.75\linewidth]{figures_proj3/fig3.7/fig3.7b1.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.25\linewidth]{figures_proj3/fig3.7/fig3.7b2.pdf}}%
    \\\adjustbox{valign=c}{\includegraphics[width=0.75\linewidth]{figures_proj3/fig3.7/fig3.7c1.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.25\linewidth]{figures_proj3/fig3.7/fig3.7c2.pdf}}%
\end{tabular}
\caption{testAb initio molecular dynamics simulations for the hydrogen-functionalized beryllene structures.
Left: 2H-$\alpha$-beryllene; Middle: 1H-$\beta$-beryllene;
Right: 2H-$\beta$-beryllene.
