...
We further examine the finite-temperature stability of the hydrogen-functionalized structures using ab initio molecular dynamics simulations.
The total energies fluctuate around stable average values during the simulations,
and the temperature profiles remain close to the target temperature range,
as shown in figure~\ref{fig:proj3_hydrogenated_aimd}.
These results support the structural stability of the hydrogen-functionalized phases at finite temperature.

\begin{figure}[!htbp]
\centering
\begin{tabular}{@{}c@{}c@{}c@{}}
    \adjustbox{valign=c}{\includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7a1.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7b1.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7c1.pdf}}%
    \\\adjustbox{valign=c}{\includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7a2.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7b2.pdf}}%
    & \adjustbox{valign=c}{\includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7c2.pdf}}%
\end{tabular}
\caption{Ab initio molecular dynamics simulations for the hydrogen-functionalized beryllene structures.
Left: 2H-$\alpha$-beryllene; Middle: 1H-$\beta$-beryllene;
Right: 2H-$\beta$-beryllene.
For each structure, the upper panel shows the total energy and the lower panel shows the temperature as functions of simulation time.}
...
\centering
    ...
    \includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7a1.pdf}
    & \includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7b1.pdf}
    & \includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7c1.pdf}
    \\\includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7a2.pdf}
    & \includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7b2.pdf}
    & \includegraphics[width=0.333\linewidth]{figures_proj3/fig3.7/fig3.7c2.pdf}

\caption{test Ab initio molecular dynamics simulations for the hydrogen-functionalized beryllene structures.
Left: 2H-$\alpha$-beryllene; Middle: 1H-$\beta$-beryllene;
Right: 2H-$\beta$-beryllene.
For each structure, the upper panel shows the total energy and the lower panel shows the temperature as functions of simulation time.}
\label{fig:proj3_hydrogenated_aimdtest}
\end{figure}
