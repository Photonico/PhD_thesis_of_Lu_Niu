...
This form makes the directional response explicit.
Each diagonal component describes the dielectric response along one principal axis, and anisotropy enters through the difference among these components.
