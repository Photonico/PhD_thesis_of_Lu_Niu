...
\begin{figure}[htbp]
\centering
    \includegraphics[width=0.95\textwidth]{figures_ch3/3.1_dielectric_sized.pdf}
...
\begin{figure}[htbp]
\centering
    \includegraphics[width=0.95\textwidth]{figures_ch3/4.1_absorption_sized.pdf}
...
\begin{figure}[htbp]
\centering
    \includegraphics[width=0.95\textwidth]{figures_ch3/4.2_refractive_sized.pdf}
...
\begin{figure}[htbp]
\centering
    \includegraphics[width=0.95\textwidth]{figures_ch3/4.3_extinction_sized.pdf}
...
In the in-plane channel, $\beta$-Beryllene develops strong features in the infrared and near-ultraviolet/ultraviolet regions, separated by a deep trough,
whereas $\alpha$-Beryllene again varies more smoothly.
In the out-of-plane channel, $\beta$-Beryllene remains stronger over the low-energy range and then decreases rapidly after approaching the near-ultraviolet region, followed by weaker oscillatory features at higher photon energies.
...
\begin{figure}[htbp]
\centering
    \includegraphics[width=0.95\textwidth]{figures_ch3/4.4_reflectivity_sized.pdf}
...
In the in-plane channel, $\beta$-Beryllene exhibits strong reflection in the low-energy and near-ultraviolet/ultraviolet regions, separated by a pronounced minimum,
...
These trends reflect the combined role of the refractive index $n_{\lambda}(\omega)$ and the extinction coefficient $k_{\lambda}(\omega)$ in determining the surface reflectivity~\cite{niu2024electronic,khan2025insight,albert2024optical,huang2023optical,suk2024ultrafast,cheng2025two,tang2025unveiling}.
...
\begin{figure}[htbp]
\centering
    \includegraphics[width=0.95\textwidth]{figures_ch3/4.5_energy-loss_sized.pdf}
