...
Firstly, for an isotropic medium, all directions are equivalent.
For this condition, the dielectric tensor $\varepsilon_{\alpha\beta}(\omega)$ reduces to a scalar dielectric function $\varepsilon(\omega)$:
