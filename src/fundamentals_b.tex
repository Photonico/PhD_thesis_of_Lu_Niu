...
where the spatial nonlocality of the dielectric response becomes negligible.
The linear response then reduces to a local frequency-dependent tensor relation:
