...
Firstly, let us stay at the most general level compatible with linear response.
In principle, the polarization at time $t$ may depend on the electric field at earlier times, and may also depend on the field in a surrounding spatial region.
Therefore, the constitutive relation generally takes a nonlocal form in both space and time~\cite{royo2019spatial}:
