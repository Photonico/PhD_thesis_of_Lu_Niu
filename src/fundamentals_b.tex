...
% Here, $v$ and $c$ label the valence bands and conduction bands, respectively.
% $E_{v\vec{k}}$ and $E_{c\vec{k}}$ denote the corresponding band energies.
% $\hat{v}_\alpha$ denotes the velocity operator along the $\alpha$ direction.
% The Dirac delta function $\delta\,\left(E_{c\vec{k}}-E_{v\vec{k}}-\hbar\omega\right)$ enforces energy conservation.
