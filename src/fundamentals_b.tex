...
we write the complex dielectric function with direction resolved:
...
Therefore, as different principal components produce different optical responses along different directions, 
optical anisotropy appears.

Draft % Draft

For layered systems, the structural plane and the normal direction organize the dielectric response most naturally~\cite{sujith2023large}.
