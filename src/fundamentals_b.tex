...
At this point, we have clarified that the dielectric function describes how internal charges polarize in response to an external electric field and how that response varies with frequency.
...
\begin{equation}
    \varepsilon_{\alpha\beta}(\omega)
    = \varepsilon_{1,\alpha\beta}(\omega) + \mathrm{i}\,\varepsilon_{2,\alpha\beta}(\omega)
