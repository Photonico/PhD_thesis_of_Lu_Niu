...
We now examine how symmetry constrains its form.
...
This notation directly prepares the comparison between the in-plane and out-of-plane dielectric spectra and optical properties.

This anisotropy also propagates to other optical quantities derived from the dielectric tensor.
