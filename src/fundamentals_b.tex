...
We now continue this optical picture inside the medium by introducing the refractive index $n_{\lambda}(\omega)$ and extinction coefficient $k_{\lambda}(\omega)$.
These two quantities characterize the propagation of the electromagnetic wave through the medium.
The refractive index determines the phase velocity,
...
we represent the electric field as:
...
$n_{\lambda}(\omega)$ denotes the refractive index,
and $k_{\lambda}(\omega)$ denotes the extinction coefficient.

This expression separates phase evolution from amplitude attenuation.
In equation~\eqref{complex_refractive_index_for_absorption_coefficient},
$n_{\lambda}(\omega)$ determines the phase evolution of the wave,
whereas $k_{\lambda}(\omega)$ describes the exponential attenuation of the wave amplitude in the medium.

\# Draft % Draft

In general, the complex refractive index satisfies:
...
For the non-magnetic media considered in the present work,
...
Using equation~\eqref{direction_resolved_complex_dielectric_function},
together with
$N_{\lambda}(\omega)=n_{\lambda}(\omega)+\mathrm{i}\,k_{\lambda}(\omega)$,
we obtain the coupled relations:
