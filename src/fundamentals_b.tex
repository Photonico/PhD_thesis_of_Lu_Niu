...
Therefore, a peak in $\varepsilon_{2,\alpha\beta}(\omega)$ appears when many optically allowed transitions gather at the same excitation energy and carry strong transition strength.
