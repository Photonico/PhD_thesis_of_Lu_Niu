...
We now move from surface reflection to energy dissipation inside the medium via examining the energy-loss spectrum $L_{\lambda}(\omega)$.
...
This quantity is directly related to the loss channels measured in electron energy-loss spectroscopy.

We first express the general form of the energy-loss spectrum along the principal direction $\lambda$ as:
