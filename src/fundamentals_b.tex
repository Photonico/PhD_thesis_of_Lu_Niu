...
we derive explicit expressions for $n_{\lambda}(\omega)$ and $k_{\lambda}(\omega)$~\cite{wooten2013optical,born2013principles,dressel2002electrodynamics,fox2010optical}.
...
We then write the general relation between the complex refractive index $N_{\lambda}(\omega)$, dielectric function $\varepsilon_{\lambda\lambda}(\omega)$, and magnetic permeability $\mu_{\lambda\lambda}(\omega)$ as~\cite{wooten2013optical,born2013principles,dressel2002electrodynamics,politano2023spectroscopic}:
...
Meanwhile, they connect the dielectric function to the interface response through the Fresnel equations~\cite{wooten2013optical,born2013principles,dressel2002electrodynamics}.
...
It equals the squared modulus of the amplitude reflection coefficient~\cite{wooten2013optical,born2013principles,dressel2002electrodynamics}:
