...
Optical dissipation strongly influences the reflectivity spectra, whereas the refractive index $n_{\lambda}(\omega)$ further modulates them.
...
We next turn to the energy-loss spectrum and describe the energy dissipation encoded in the dielectric response.
