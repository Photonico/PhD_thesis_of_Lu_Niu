...
% Therefore, once we enter the linear-response regime, the frequency domain provides the natural language for discussing the optical response.
...
In crystalline materials, however, anisotropy often survives, so we retain the tensor form and later compare the optical response along different directions~\cite{han2023temperature}.
