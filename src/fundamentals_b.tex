...
Here, the complex dielectric function describes the response of matter to an external electric field.
We then derive the optical quantities discussed below.

When we have $\varepsilon(\omega)$,
we can derive the absorption coefficient $\alpha(\omega)$.
