...
we express the refractive index $n_{\lambda}(\omega)$ as:
...
\label{refractive_index_from_dielectric_respons}
\end{equation}
...
In the present work for xene systems,
we consider two principal optical channels,
they are the in-plane channel $\varparallel$ and the out-of-plane channel $\perp$.
This allows a direct comparison between the two optical directions.
