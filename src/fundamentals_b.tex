...
as the central quantity that describes the optical response of
the present systems.
We now use the same dielectric response to determine the
...
In what follows, we first present the general relations that
connect these quantities to $\varepsilon(\omega)$, and then
analyze the in-plane and out-of-plane optical response of the
present systems.
