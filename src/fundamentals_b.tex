...
The following figure presents the calculated reflectivity spectra of $\alpha$-Beryllene and $\beta$-Beryllene for the in-plane and out-of-plane directions:
...
The previous subsection introduced the reflectivity $R_{\lambda}(\omega)$ as the surface response characterized by the refractive index $n_{\lambda}(\omega)$ and the extinction coefficient $k_{\lambda}(\omega)$.
We now return from surface reflection to energy dissipation inside the medium.
To complete the optical description derived from the dielectric response, we examine the energy-loss spectrum $L_{\lambda}(\omega)$.
...
In particular, it describes the spectral strength of longitudinal energy dissipation and therefore identifies the energy range where collective electronic response becomes most pronounced.
This quantity is widely used to describe the loss channels probed by electron energy-loss spectroscopy.

We first write the general form of the energy-loss spectrum along the principal direction $\lambda$ as:
...
\begin{equation}
    ...
    \mathrm{Im}
    \left[
        -\frac{1}{\varepsilon_{\lambda\lambda}(\omega)}
    \right]
\label{energy_loss_spectrum_from_inverse_dielectric_function}
\end{equation}

This expression shows that the energy-loss spectrum is determined by the inverse dielectric response.
Therefore, it does not only follow the absorptive part of the medium, but also depends on the screening effect encoded in the full complex dielectric function.
A strong loss peak develops when the dielectric screening becomes weak, which usually occurs near the energy range where the real part of the dielectric function approaches zero while the imaginary part remains finite.

Using the direction-resolved complex dielectric function in equation~\eqref{direction_resolved_complex_dielectric_function}:
...
\begin{equation}
    ...
    +
    \mathrm{i}\,\varepsilon_{2,\lambda\lambda}(\omega)
\label{direction_resolved_complex_dielectric_function_for_energy_loss}
\end{equation}

we then obtain the explicit expression used in the present work:
...
This equation makes the physical roles of the two parts of the dielectric function transparent.
...
As a result, the energy-loss spectrum becomes large when the medium can absorb energy efficiently and meanwhile fails to screen the external perturbation strongly.
In this sense, $L_{\lambda}(\omega)$ emphasizes resonant loss channels more directly than the absorption coefficient or the reflectivity.

The following figure presents the calculated energy-loss spectra of $\alpha$-Beryllene and $\beta$-Beryllene for the in-plane and out-of-plane directions:
...
The energy-loss spectra demonstrate a directional contrast that is even sharper than that in the reflectivity.
In the in-plane channel, $\beta$-Beryllene develops an evident low-energy loss peak in the visible range, whereas $\alpha$-Beryllene remains very weak at low photon energy and then rises strongly in the high-energy region.
Above about $7$~eV, the in-plane loss response of $\alpha$-Beryllene increases rapidly and forms a broad strong structure before rising again near the upper end of the present energy window.
This behavior indicates that the dominant loss channels of $\alpha$-Beryllene are concentrated in the high-energy range, whereas $\beta$-Beryllene already supports a visible-range loss feature.

In the out-of-plane channel, the contrast becomes stronger.
$\alpha$-Beryllene develops several very sharp and intense loss peaks in the ultraviolet range, whereas $\beta$-Beryllene shows weaker and broader structures over the same interval.
Therefore, the out-of-plane dielectric response of $\alpha$-Beryllene supports much stronger resonant loss channels at high photon energy.
Meanwhile, $\beta$-Beryllene maintains a more moderate loss response with less abrupt spectral variation.

These results show that the energy-loss spectrum depends strongly on both the optical direction and the crystal structure of the medium.
Because $L_{\lambda}(\omega)$ is determined by the inverse dielectric function, its peaks mark the energy range where the dielectric screening changes most critically.
Therefore, the energy-loss spectrum provides a compact way to identify the dominant dissipation channels that are not equally visible in absorption or reflectivity alone.

Consequently, the energy-loss spectrum $L_{\lambda}(\omega)$ characterizes the energy transferred from an external probe to the medium and identifies the dominant resonant loss channels encoded in the dielectric response.
We arrive at the final optical quantity derived from $\varepsilon_{\lambda\lambda}(\omega)$, which completes the chain from optical attenuation, to wave propagation, to surface reflection, and finally to intrinsic energy dissipation in the medium.
