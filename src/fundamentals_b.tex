...
Therefore, the microscopic transition strength already resolves the field polarization and the crystal orientation.
...
which collects the energy-conserving interband transitions and weights them by their direction-resolved transition strength.
This point naturally leads us to the dielectric response in anisotropic media~\cite{huang2023optical}.
