...
the reflectivity $R(\omega)$,
and the energy-loss function $L(\omega)$
also inherit the same anisotropy.
...
we next connect these two parts for each direction through the Kramers--Kronig relations.

Draft % Draft


and causality links these two parts for each direction separately.
