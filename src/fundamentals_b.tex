...
In the previous subsection, we presented the dielectric tensor $\varepsilon_{\alpha\beta}(\omega)$ as a compact description of the linear electric response.
...
In this section, we start with expressing the polarization response in the language of electric susceptibility and the complex dielectric function.
