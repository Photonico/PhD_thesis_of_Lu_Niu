...
The Graphene-\ce{BC3} and Graphene-\ce{B4C3} bilayer heterojunction systems maintain the Dirac point of graphene at the $\vec{k}$-point and are semi-metals,
...
while  Graphene-\ce{BC3} and Graphene-\ce{B4C3} are semi-metals.
...
Graphene-\ce{B4C3} appears to have kept the character of the respective monolayers,
displaying essentially semi-metal behaviour with the \ce{B4C3} states located away from the Fermi level (i.e. above $\approx 1.2$ eV and below $\approx-0.8$ eV) as seen from the PDoS in figure~\ref{S1.11}.
