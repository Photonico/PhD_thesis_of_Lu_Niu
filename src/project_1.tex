...
Figure~\ref{figS1.2} shows the optimization of the lattice constants for the monolayers,
while figure~\ref{fig1.2_monolayers_bs} presents the band structures of the four monolayer systems.

\begin{figure}[htbp]
    \centering
    \includesvg[width=0.80\textwidth]{figures_proj1/proj1.1.svg}
...
The supplementary information below includes results on the determination of the lattice parameters used in the calculations for the graphene, borophene, \ce{BC3}, and \ce{B4C3} monolayers.
It also includes the corresponding results for their associated heterostructure bilayer systems under various relative lateral displacements.
It also includes convergence tests of the $\vec{k}$-point meshes and the band structures of the monolayers and all bilayer systems investigated, calculated using the PBE and HSE06 functionals.
...
Figures~\ref{S1.4}, ~\ref{S1.5}, and~\ref{S1.6} show the total energy as a function of the lattice constant and interlayer distance for the various lateral positions considered.
In each figure, the equilibrium geometry is indicated by the ``Extrema of fitted data'' result.

\begin{figure}[htbp]
\centering
\includesvg[width=1.00\textwidth]{figures_proj1/S1.4.svg}
...
\begin{figure}[htbp]
\centering
\includesvg[width=0.80\textwidth]{figures_proj1/S1.5.svg}
...
\begin{figure}[htbp]
\centering
\includesvg[width=0.80\textwidth]{figures_proj1/S1.6.svg}
\caption{Total-energy landscape of the \ce{Graphene-B4C3} bilayer.}
\label{S1.6}
\end{figure}

Figures~\ref{S1.9}, \ref{S1.10}, and~\ref{S1.11} show the projected densities of states of the three heterostructure systems calculated using the HSE06 functional.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures_proj1/S1.9.pdf}
\caption{HSE06 projected density of states of \ce{Graphene-BC3}.}
\label{S1.9}
\end{figure}
...
\caption{HSE06 projected density of states of \ce{Graphene-Borophene}.}
\label{S1.10}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures_proj1/S1.11.pdf}
\caption{HSE06 projected density of states of \ce{Graphene-B4C3}.}
\label{S1.11}
\end{figure}
