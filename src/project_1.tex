...
This is consistent with the smaller interlayer distance,
due to the hollow site relative coordination rather than the top site,
as for the  Graphene-Bororphene and \ce{Graphene-B4C3} heterostructures. 
...
This gives rise to the patterns in the charge accumulation/depletion regions shown in the top and bottom views of figure~\ref{fig1.4_cdd}. 
Therefore, we find that the relative coordination between the bilayer heterostructures has a direct impact on their electronic properties. 
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=1.0\textwidth]{figures_proj1/proj1.4.svg}
    \caption{$\Delta \rho(\vec{r})$, calculated using equation~\ref{charge_density_difference}) between the monolayers and the heterostructures.
