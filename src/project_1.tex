...
In this chapter,
we investigate the atomic, electronic, and optical properties of two-dimensional graphene, borophene, and boron-carbide heterojunction bilayer systems,
...
Our calculations show that borophene is metallic,
whereas monolayer \ce{BC3} and \ce{B4C3} are indirect semiconductors,
with HSE06 band gaps of \qty{1.822}{\electronvolt} and \qty{2.381}{\electronvolt}, respectively.
...
whereas Graphene-Borophene is metallic.
All bilayer heterostructure systems exhibit absorption in the visible region, with resonance frequencies and resonance absorption peak intensities that vary between structures.
In addition, all heterojunctions support plasmons within the range \qtyrange{16.5}{18.5}{\electronvolt},
while Graphene-\ce{B4C3} and Graphene-Borophene exhibit a $\pi$-type plasmon within the range \qtyrange{4}{6}{\electronvolt},
with the latter possessing an additional lower-energy plasmon within the range \qtyrange{1.5}{3}{\electronvolt}.
The dielectric tensor of Graphene-\ce{B4C3} exhibits complex off-diagonal elements due to its lower $P3$ space-group symmetry,
indicating anisotropic dielectric properties and possible optically active (chiral) effects.
These results show that these two-dimensional heterostructures have desirable optical properties and broaden their potential applications.

\newpage
\section{Introduction}

Graphene combines excellent electrical conductivity,
desirable mechanical and thermal properties,
and high light transmittance in the visible-light and infrared regions.
It also exhibits extremely high quantum efficiency for light-matter interactions and strong optical nonlinearity.
These properties have therefore enabled applications in, for example, electronics, energy storage, biomedical devices, and other fields~\cite{janavika2023graphene}.
Relative to conventional plasmonic materials, graphene supports highly confined plasmons with much longer lifetimes.
In addition, graphene plasmons are active over an extended wavelength range, namely the mid-infrared and terahertz regimes.
This wavelength range overlaps with the characteristic signals of most organic and biomolecules,
which has broadened graphene applications toward plasmonic biological and chemical sensors~\cite{sakthivel2023}, as well as plasmonic waveguides and infrared photodetectors.
Moreover, forming graphene-hybrid materials can tune the properties of graphene, enabling applications in biosensors, chemical sensors, optical sensors, and other types of sensors~\cite{zhang2022}.

In other areas, however, the use of graphene remains limited by its zero band gap.
One route to expanding the application of graphene is to form heterostructures.
Stacking different two-dimensional (2D) materials together can form double-layer or even multi-layer artificial materials maintained by van der Waals interactions~\cite{novoselov20162d}.
Such materials are known as van der Waals heterojunctions.
This stacking can generate a wide range of physical properties,
making van der Waals heterojunctions even more important than the individual 2D materials themselves.
Because many 2D materials are available, their heterostructures can provide a diverse range of electrical, photonic, plasmonic, mechanical, and chemical properties.
These properties can be theoretically predicted through \textit{ab initio} calculations and machine learning~\cite{thygesen2017,he2023}, and experimentally engineered~\cite{lin2023recent,elbanna20232d}.

The prospect of developing plasmonic devices based on 2D semiconductors has recently attracted considerable attention~\cite{agarwal2018plasmonics, qiu2018optical}.
Plasmonic modes in different classes of van der Waals semiconductors have their own peculiarities and potential technological capabilities.
Graphene-like \ce{BC3} has recently been synthesized experimentally~\cite{yanagisawa2004phonon, yanagisawa2006phonon, tanaka2005novel} and has been found to be semiconducting with an indirect band gap.
Calculations show that nanostructures of graphene-like \ce{BC3} exhibit desirable absorption in the visible region.
By changing the size of the nanostructure, the resonance peak position of the absorption spectrum can be effectively regulated~\cite{chen2019plasmon}.
...
This monolayer allotrope of boron forms several structures and exhibits a unique atomic structure and exceptional electronic properties.
These features have opened new avenues for innovation in electronics,
energy storage, catalysis, plasmonics, superconductivity, and sensors~\cite{qiu2018optical}.
One particularly intriguing aspect of borophene lies in its ability to form heterojunctions,
including interfaces between different borophene structures and interfaces between borophene and other materials.
Borophene-graphene heterostructures have been realized~\cite{hou2021borophene}.
These heterostructures show good stability and can function as humidity sensors,
with a sensitivity about 700 times higher than that of pristine graphene and 27 times higher than that of borophene.
...
may support a wide range of applications spanning from electronics and optoelectronics to energy storage and sensing.
...
and the exploration of novel applications will remain key focal points.
To date, only limited information is available on the physical properties of graphene-based bilayer heterojunctions with borophene and boron-carbide materials.
This motivates us to investigate these heterojunctions
by studying their electronic and optical properties on the basis of first-principles calculations.
Such understanding is crucial for future technological applications,
where the unique properties of these materials can be harnessed.

This chapter is organised as follows.
In section~\ref{1_calculation_method}, we describe the calculation method.
In section~\ref{1_results}, we present the results and discussion.
There, we examine the physical properties of the monolayers and heterostructures, including band structures, densities of states, electron density difference distributions,
Schottky barriers, and optical properties.
Finally, section~\ref{1_conclusions} gives the conclusion.
