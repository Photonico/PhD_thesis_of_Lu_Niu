...
The Graphene-\ce{BC3} and Graphene-\ce{B4C3} bilayer heterojunction systems maintain the Dirac point of graphene at the $\vec{k}$-point and are semimetals,
...
Remarkably, all heterojunctions support plasmons within the range $16.5-18.5$ eV, while Graphene-\ce{B4C3} and Graphene-Borophene exhibit a $\pi$-type plasmon within the region 4-6 eV,
...
It can be seen from table~\ref{tab:1.2_heterostructure} that Graphene-Borophene is metallic, 
...
It is notable that the Graphene-\ce{BC3} heterojunction exhibits a sizeable density of states just above the Fermi level (see figure~\ref{S1.9}),
...
The Graphene-Borophene system exhibits metallic behaviour due to the small occupation of states at the $\mathrm{K}$ point, which are mainly carbon-related, as seen from the PDoS in figure~\ref{S1.10}.
...
Across these three bilayer, the main difference between PBE and HSE06 appears to be the raising and lowering of the conduction and valence bands by HSE06, respectively,
...
The graphene and boron-carbide bilayer structures can function as a Schottky diode.
A high Schottky barrier will block the reverse (metal-to-semiconductor) current, realizing
the rectification effect of a diode. Based on the Schottky-Mott model (shown in figure~\ref{fig1.8}, left), at the metal-semiconductor interface~\cite{guo2017all} in $n$-type materials the Schottky barrier ($\Phi_n$) is defined as the energy difference between the Fermi level ($E_F$) and the conduction band
minimum ($E_C$),
that is, $\Phi_n = E_C - E_f$.
Similarly, in $p$-type materials the Schottky barrier ($\Phi_p$) is defined as the energy difference between the Fermi level ($E_F$) and the VBM ($E_V$),
that is, $\Phi_p = E_F - E_V$~\cite{guo2017all, liu2018tuning}.
The sum of two types of Schottky barriers is approximately equal to the band gap value ($E_g$) of of the semiconductor,
that is $\Phi_n + \Phi_p = E_g$.
For For the Graphene-\ce{B4C3} system as illustrated in figure~\ref{fig1.8},
right, we find $\Phi_n = \qty{1.42}{\electronvolt} (\qty{1.07}{\electronvolt})$ for the HSE06(PBE),
and $\Phi_p = \qty{0.87}{\electronvolt} (\qty{0.55}{\electronvolt})$ for the HSE06 (PBE) signifying the heterojunction forms a $p$-type Schottky barrier since
$\Phi_p<\Phi_n$
For the Graphene-\ce{BC3} heterostructure bilayer,
we find $\Phi_n = \qty{0.19}{\electronvolt} (\qty{0.003}{\electronvolt})$ for the HSE06(PBE),
and $\Phi_p = \qty{0.87}{\electronvolt} (\qty{0.55}{\electronvolt})$ for the HSE06 (PBE) signifying the heterojunction forms a $n$-type Schottky barrier.
For device applications a smaller Schottky
...
\begin{figure}[!htbp]
    ...
    \caption{\textbf{Left:} Schematic of the Schottky--Mott model showing the valence and conduction band energies, the Fermi energy, and $n$-type and $p$-type Schottky barriers labelled $E_V$, $E_C$, $E_F$, $\Phi_n$, and $\Phi_p$, respectively. \textbf{Right:} Example for the HSE06-calculated Graphene-\ce{B4C3} heterojunction showing the determined Schottky barrier height from the band structure.}
    \label{fig1.8}
\end{figure}
...
\caption{Projected density of states of Graphene-\ce{BC3} by HSE06.}
\label{S1.9}
\end{figure}
...
\caption{Projected density of states of Graphene-Borophene by HSE06.}
\label{S1.10}
\end{figure}
...
\caption{Projected density of states of Graphene-\ce{B4C3} by HSE06.}
\label{S1.11}
\end{figure}
...
\caption{Convergence test for the number of unoccupied bands in calculating the dielectric function of the Graphene-\ce{B4C3} bilayer as calculated using the PBE functional.}
\label{S1.15}
\end{figure}

\clearpage We also test the effect of the energy convergence criteria \texttt{EDIFF} on the calculated dielectric function in figure~\ref{S1.16} along with different $\vec{k}$-point meshes and comparison of HSE06 and PBE.
...
\clearpage Figures~\ref{S1.20}--\ref{S1.24} show the HSE06 optical properties of the three bilayer heterostructures, including the absorption coefficient, energy-loss spectrum, reflectivity, refractive index, and extinction coefficient.
