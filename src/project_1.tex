...
The calculated indirect band gaps of \ce{BC3} and \ce{B4C3} are 1.822 eV (0.634 eV) and 2.381 eV (1.647 eV), respectively, as obtained using HSE06 (PBE).
Figure~\ref{fig1.1} shows the optimization of the lattice constants for the monolayers,
while figure~\ref{fig1.2_monolayers_bs} presents the band structures of the four monolayer systems.

\begin{figure}[htbp]
    \centering
    \includesvg[width=0.96\textwidth]{figures_proj1/proj1.1.svg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.48\linewidth]{figures_proj1/proj1.3a.pdf}%
    \includegraphics[width=0.48\linewidth]{figures_proj1/proj1.3b.pdf}%
    \par\nointerlineskip
    \includegraphics[width=0.48\linewidth]{figures_proj1/proj1.3c.pdf}%
    \includegraphics[width=0.48\linewidth]{figures_proj1/proj1.3d.pdf}%
...
We studied the relative energies, optimized lattice constants, and inter-planar distances for all structures.
...
\begin{figure}[htbp]
    \centering
    \includesvg[width=1.00\textwidth]{figures_proj1/proj1.3.svg}
...
The charge density difference distributions for the heterostructure systems are shown in figure~\ref{cddd} as calculated using equation \ref{eqn:charge_difference} by subtracting the charge density of the  monolayers from the charge density of the heterostructure system. It is clear from the side view (middle panels) in figure \ref{cddd} that in all cases there is charge depletion from the graphene layer (top layer) and accumulation in the alternate monolayer.  The largest charge redistribution is found for Graphene-\ce{BC3}. This is consistent with the smaller interlayer distance, due to the hollow site relative coordination rather than the top site, as for the  Graphene-Bororphene and Graphene-\ce{B4C3} heterostructures. We also observe that atoms in the lower layers which directly coordinate with a carbon atom in the graphene layer have the largest charge accumulation regions. In contrast, the carbon atoms in the graphene layer with bridge or hollow coordination to the atoms of the lower layer show the largest regions of charge depletion. This gives rise to the patterns in the charge accumulation/depletion regions shown in the top and bottom views of figure \ref{cddd}. Therefore, we find the relative coordination between the bilayer heterostructures has a direct impact on their electronic properties. 
For the Graphene-\ce{B4C3} heterostructure, quite striking is the 3-fold rotational symmetry as seen from the top and bottom views (upper and lower plots of the rightmost panel). 

In the next sections the band structure and density of states are investigated to further characterise the electronic structure of these heterostructure systems.       


\begin{figure}[htbp]
    \centering
    \includesvg[width=0.96\textwidth]{figures_proj1/proj1.4.svg}
    \caption{$\Delta \rho(\vec{r})$, calculated using equation~\ref{eqn:charge_difference}) between the monolayers and the heterostructures.
