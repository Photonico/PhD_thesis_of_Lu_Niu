...
The Graphene-\ce{BC3} and Graphene-\ce{B4C3} bilayer heterojunction systems maintain the Dirac point of graphene at the $\mathrm{K}$ and are semimetals,
...
Remarkably, all heterojunctions support plasmons within the range \qtyrange{16.5}{18.5}{\electronvolt}, while Graphene-\ce{B4C3} and Graphene-Borophene exhibit a $\pi$-type plasmon within the region 4-6 eV,
...
For each system,
we considered various lateral stacking positions of these layers.
...
\begin{figure}[!htbp]
    ...
    \caption{Total energy as a function of the $\vec{k}$-point mesh used to sample the Brillouin zone for the Graphene-\ce{BC3} bilayer. Here, $X$ denotes an $X \times X \times 1$~$\vec{k}$-point mesh.}
    \label{S1.1}
\end{figure}
...
\clearpage
Figures~\ref{S1.4}--\ref{S1.6} show the total energy as a function of the lattice constant and interlayer distance for the various lateral positions considered.
...
\caption{Convergence test of the dielectric function Graphene-\ce{B4C3} with respect to the number of unoccupied bands, calculated using PBE.}
\label{S1.15}
\end{figure}
...
\caption{Dielectric function of the Graphene-Borophene bilayer comparing HSE06 results obtained using $17 \times 17 \times 1$ and $65 \times 65 \times 1$ $\vec{k}$-point meshes,
...
The off-diagonal components are small but non-zero and approximately satisfy the antisymmetric relations $\varepsilon_{yx}=-\varepsilon_{xy}$, $\varepsilon_{yz}=-\varepsilon_{zy}$, and $\varepsilon_{zx}=-\varepsilon_{xz}$.
