...
\caption{Real and imaginary part of the dielectric function for the monolayers as calculated using the PBE functional with a 
$129\times 129\times 129$
$\vec{k}$-point mesh for Graphene and a
$65\times 65 \times 65$ mesh for the other monolayer.}
\label{S1.13}
\end{figure}
