...
For the bilayer system,
the band structures and total density of states (DoS) are shown in figures~\ref{fig1.5}--\ref{fig1.7} as calculated using the HSE06 and PBE functionals.
The corresponding atom-projected (or partial) PDoS are presented in figures~\ref{S1.9}--\ref{S1.11}.

The Graphene-Borophene system exhibits metallic behaviour due to the small occupancy of states at the $\vec{k}$-point which are mainly carbon related as seen from the PDoS in figure~\ref{S1.10}.
...
It is notable that the Graphene-\ce{BC3} heterojunction exhibits a sizeable density-of-states just above the Fermi level (see figure~\ref{S1.9}) which is related to the relatively flat band near the M-point and along K to $\Gamma$ in the Brillouin zone.
For these bilayer systems, the main difference between the PBE and HSE06 appears to be the raising and lowering of conduction and valence bands of the HSE06, respectively,
relative to those obtained by the PBE functional.
At the $\vec{k}$-point the graphene bands exhibit a very small band-gap opening of \qty{20}{\milli\electronvolt} and
\qty{50}{\milli\electronvolt} for Graphene-\ce{B4C3} and Graphene-\ce{BC3}, respectively.

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures_proj1/proj1.5.pdf}
\caption{Band structure and total DOS for Graphene-\ce{BC3} as calculated using the PBE (blue) and HSE06 (orange) functionals.
The Fermi level is indicated by the purple dashed line.}
\label{fig1.5}
\end{figure}

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures_proj1/proj1.6.pdf}
\caption{Band structure and total DOS for Graphene-Borophene as calculated using the PBE (blue) and HSE06 (orange) functionals.
The Fermi level is indicated by the purple dashed line.}
\label{fig1.6}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures_proj1/proj1.7.pdf}
\caption{Band structure and total DOS for Graphene-\ce{B4C3} as calculated using the PBE (blue) and HSE06 (orange) functionals.
The Fermi level is indicated by the purple dashed line.}
\label{fig1.7}
\end{figure}
