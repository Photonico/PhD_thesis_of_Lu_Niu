...
We perform first-principle calculations using density functional theory (DFT) as implemented in the Vienna Ab initio Simulation Package (VASP) \cite{kresse1993ab, kresse1996efficiency, kresse1996software}.
