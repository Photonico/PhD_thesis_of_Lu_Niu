...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{figures_proj1/S1.1.pdf}
...
\begin{figure}[htbp]
    ...
    \caption{Total energy versus lattice constant and interlayer distance for the \ce{Graphene-BC3} bilayer for the various lateral positions considered.
    The determined equilibrium geometry is indicated by the ``Extrema of fitted data'' result.}
    \label{S1.4}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Total energy versus lattice constant and interlayer distance for the \ce{Graphene-Borophene} bilayer for the various lateral positions considered.
    The determined equilibrium geometry is indicated by the ``Extrema of fitted data'' result.}
    \label{S1.5}
\end{figure}
...
\begin{figure}[htbp]
    ...
    % \caption{Total energy versus lattice constant and interlayer distance for the \ce{Graphene-B4C3} bilayer for the various lateral positions considered. 
    % The determined equilibrium geometry is indicated by the ``Extrema of fitted data'' result.}
    \label{S1.6}
\end{figure}
